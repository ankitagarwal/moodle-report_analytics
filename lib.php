...
function report_analytics_extend_navigation_course($navigation, $course, $context) {
    if (has_capability('report/analytics:view', $context)) {
        $url = new moodle_url('/report/analytics/index.php', array('courseid' => $course->id));
        $navigation->add(get_string('pluginname', 'report_analytics'), $url, navigation_node::TYPE_SETTING, null, null,
